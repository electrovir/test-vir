...
node dist/isolated-test-files/api-test.js;
node dist/isolated-test-files/api-format-test.js;

set +e;
# check unresolved promises
checkFile="dist/isolated-test-files/input-files/unresolvable-promise-input.js";
...
checkFile="dist/isolated-test-files/input-files/force-only-input.js";
